...
knitr::kable(lang_tbl, caption = 'Average minority language estimates by corpus and annotation method.', 
             booktabs=T, 
             row.names = FALSE, 
             col.names = c("Corpus (language)", "Random", "All-day", "Avg. relative error (SD)", "n=100 simulations of random sampling Avg. (SD) Range", "Correlation between estimates")) %>% 
...
jpeg("/Users/megcychosz/Google Drive/biling_CDS/results/figures/cds_density_plot.jpeg", height = 400, width = 700)
cds_density
dev.off()
...
jpeg("/Users/megcychosz/Google Drive/biling_CDS/results/figures/reg_density_plot.jpeg", height = 400, width = 700)
reg_density
dev.off()
```
...
knitr::kable(final_reg_tbl, caption = 'Average adult-directed speech estimates by corpus and annotation method.', 
             booktabs=T, 
             row.names = FALSE, 
             col.names = c("Corpus", "Random", "All-day", "Average relative error (SD)", "n=100 simulations of random sampling Avg. (SD) Range",  "Correlation between estimates")) %>% 
