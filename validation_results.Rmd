...
jpeg("/Users/megcychosz/Google Drive/biling_CDS/results/figures/min_lang_density_plot.jpeg", height = 400, width = 700)
lang_density
dev.off()
```
...
# current not doing this as we're not fitting models to the 'complete' dataset
...
#span_model_data_full <- span_rolling_complete2 %>% # Bolivia & US; all the data from the 'all-day' annotation
#  group_by(id) %>%
#  arrange(annotation_num)
