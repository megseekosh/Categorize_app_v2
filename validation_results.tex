...
\NormalTok{data_avbl <-}\StringTok{ }\NormalTok{config_files }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct}\NormalTok{(file_name, }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# duplicates bc drawn with replacement}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(sleeping}\OperatorTok{==}\StringTok{'1'} \OperatorTok{|}\StringTok{ }\NormalTok{researcher_present }\OperatorTok{==}\StringTok{ '1'} \OperatorTok{|}\StringTok{ }\NormalTok{voc }\OperatorTok{==}\StringTok{ '0'}\NormalTok{) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{merge}\NormalTok{(., data_annon, }\DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{'id'}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{avbl_clips =}\NormalTok{ num_clips }\OperatorTok{-}\StringTok{ }\NormalTok{not_avl_clips) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# clips that were *available* for annotation out of the total # of clips from the recording; it's the same for both methods because the # of available clips to draw is the same for both methods}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{percen_avl_annon =}\NormalTok{ (speech_clips }\OperatorTok{/}\StringTok{ }\NormalTok{avbl_clips)}\OperatorTok{*}\DecValTok{100}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# the # of clips annotated / # of avbl clips; % should be smaller for random}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# now simulate 100 minority lang estimates from each child}
\CommentTok{# take however many clips were used to compute the randomly-sampled estimate}
\CommentTok{# then compute the prop. of those that are spanish/quechua}
\CommentTok{# repeat 100X}
\NormalTok{nsims=}\DecValTok{100}
\CommentTok{# total_reg_annotations refers to the # of clips used to estimate language prop }
\CommentTok{# get that variable}
\NormalTok{random_lang_clips <-}\StringTok{ }\NormalTok{lang_annon }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(method}\OperatorTok{==}\StringTok{'random'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct_at}\NormalTok{(., }\KeywordTok{vars}\NormalTok{(id), }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(id, total_lang_annotations)}

\NormalTok{sim_lang_data <-}\StringTok{ }\NormalTok{lang_annon }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(method}\OperatorTok{==}\StringTok{'complete'}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# we're only sampling from all-day annotations}
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{total_lang_annotations) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# this is the # of all-day clips annotated and we want # of random clips}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., random_lang_clips, }\DataTypeTok{by=}\StringTok{'id'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{replicate}\NormalTok{(nsims, ., }\DataTypeTok{simplify =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# simulate 100 collections of random clips}
\StringTok{  }\KeywordTok{map_dfr}\NormalTok{(}\OperatorTok{~}\StringTok{ }\KeywordTok{sample_n}\NormalTok{(., total_lang_annotations), }\DataTypeTok{.id =} \StringTok{"simulation"}\NormalTok{) }\CommentTok{# sample the same # of clips per simulation that were annotated for random sampling}
  
\CommentTok{# now compute the Quechua estimate for the Bolivia corpus}
\NormalTok{que_sim_results <-}\StringTok{ }\NormalTok{sim_lang_data }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(language}\OperatorTok{==}\StringTok{'English/Quechua'} \OperatorTok{&}\StringTok{ }\NormalTok{location}\OperatorTok{==}\StringTok{'Bolivia'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id, simulation) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct}\NormalTok{(file_name, }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{n_que=}\KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct}\NormalTok{(id, }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{percen_que =}\NormalTok{ n_que }\OperatorTok{/}\StringTok{ }\NormalTok{total_lang_annotations) }\CommentTok{# compute que/to all else}

\CommentTok{# and the Spanish estimate for the US corpus}
\NormalTok{span_sim_results <-}\StringTok{ }\NormalTok{sim_lang_data }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(language}\OperatorTok{==}\StringTok{'Spanish'} \OperatorTok{&}\StringTok{ }\NormalTok{location}\OperatorTok{==}\StringTok{'US'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id, simulation) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct}\NormalTok{(file_name, }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{n_span=}\KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct}\NormalTok{(id, }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{percen_span =}\NormalTok{ n_span }\OperatorTok{/}\StringTok{ }\NormalTok{total_lang_annotations) }\CommentTok{# compute span/to all else}

\CommentTok{# now some descriptive stats from those results}
\CommentTok{# by corpus}
\NormalTok{que_sim_stats <-}\StringTok{ }\NormalTok{que_sim_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_sim_que =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(percen_que),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{sd_sim_que =} \KeywordTok{round}\NormalTok{(}\KeywordTok{sd}\NormalTok{(percen_que),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{min_sim_que =} \KeywordTok{round}\NormalTok{(}\KeywordTok{range}\NormalTok{(percen_que)[}\DecValTok{1}\NormalTok{],}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{max_sim_que =} \KeywordTok{round}\NormalTok{(}\KeywordTok{range}\NormalTok{(percen_que)[}\DecValTok{2}\NormalTok{],}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_stat =} \KeywordTok{paste}\NormalTok{(mean_sim_que,}\StringTok{"("}\NormalTok{,sd_sim_que,}\StringTok{")"}\NormalTok{,min_sim_que,}\StringTok{"-"}\NormalTok{,max_sim_que)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(sim_stat)}

\NormalTok{span_sim_stats <-}\StringTok{ }\NormalTok{span_sim_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_sim_span =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(percen_span),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{sd_sim_span =} \KeywordTok{round}\NormalTok{(}\KeywordTok{sd}\NormalTok{(percen_span),}\DecValTok{2}\NormalTok{),}
          \DataTypeTok{min_sim_span =} \KeywordTok{round}\NormalTok{(}\KeywordTok{range}\NormalTok{(percen_span)[}\DecValTok{1}\NormalTok{],}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{max_sim_span =} \KeywordTok{round}\NormalTok{(}\KeywordTok{range}\NormalTok{(percen_span)[}\DecValTok{2}\NormalTok{],}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_stat =} \KeywordTok{paste}\NormalTok{(mean_sim_span,}\StringTok{"("}\NormalTok{,sd_sim_span,}\StringTok{")"}\NormalTok{,min_sim_span,}\StringTok{"-"}\NormalTok{,max_sim_span)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(sim_stat)}

\CommentTok{# now the spanish estimate by individual child in US corpus}
\NormalTok{span_sim_child_stats <-}\StringTok{ }\NormalTok{span_sim_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_sim_span =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(percen_span),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{sd_sim_span =} \KeywordTok{round}\NormalTok{(}\KeywordTok{sd}\NormalTok{(percen_span),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{min_sim_span =} \KeywordTok{round}\NormalTok{(}\KeywordTok{range}\NormalTok{(percen_span)[}\DecValTok{1}\NormalTok{],}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{max_sim_span =} \KeywordTok{round}\NormalTok{(}\KeywordTok{range}\NormalTok{(percen_span)[}\DecValTok{2}\NormalTok{],}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_stat_child =} \KeywordTok{paste}\NormalTok{(mean_sim_span,}\StringTok{"("}\NormalTok{,sd_sim_span,}\StringTok{")"}\NormalTok{,min_sim_span,}\StringTok{"-"}\NormalTok{,max_sim_span)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(id, sim_stat_child)}

\CommentTok{# and the quechua estimate by individual child in Bolivia corpus}
\NormalTok{que_sim_child_stats <-}\StringTok{ }\NormalTok{que_sim_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_sim_que =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(percen_que),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{sd_sim_que =} \KeywordTok{round}\NormalTok{(}\KeywordTok{sd}\NormalTok{(percen_que),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{min_sim_que =} \KeywordTok{round}\NormalTok{(}\KeywordTok{range}\NormalTok{(percen_que)[}\DecValTok{1}\NormalTok{],}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{max_sim_que =} \KeywordTok{round}\NormalTok{(}\KeywordTok{range}\NormalTok{(percen_que)[}\DecValTok{2}\NormalTok{],}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_stat_child =} \KeywordTok{paste}\NormalTok{(mean_sim_que,}\StringTok{"("}\NormalTok{,sd_sim_que,}\StringTok{")"}\NormalTok{,min_sim_que,}\StringTok{"-"}\NormalTok{,max_sim_que)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(id, sim_stat_child)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{span_lang_estimate <-}\StringTok{ }\NormalTok{span }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(location}\OperatorTok{==}\StringTok{'US'}\NormalTok{) }
\NormalTok{que_lang_estimate <-}\StringTok{ }\NormalTok{que }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(location}\OperatorTok{==}\StringTok{'Bolivia'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{actual_percen_minority =}\NormalTok{ percen_que)}
\NormalTok{actual_lang_estimate <-}\StringTok{ }\NormalTok{span_lang_estimate }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{actual_percen_minority =}\NormalTok{ percen_span) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{rbind}\NormalTok{(., que_lang_estimate) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(method}\OperatorTok{==}\StringTok{'random'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(id, actual_percen_minority)}

\NormalTok{que_sim_results2 <-}\StringTok{ }\NormalTok{que_sim_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_percen_minority =}\NormalTok{ percen_que)}
\NormalTok{minority_sim_results <-}\StringTok{ }\NormalTok{span_sim_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_percen_minority =}\NormalTok{ percen_span) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{rbind}\NormalTok{(., que_sim_results2)}
  
\NormalTok{dropLeadingZero <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(l)\{}
  \KeywordTok{str_replace}\NormalTok{(l, }\StringTok{'0(?=.)'}\NormalTok{, }\StringTok{''}\NormalTok{)}
\NormalTok{\}}

\CommentTok{#minority language}
\NormalTok{lang_density <-}\StringTok{ }\NormalTok{actual_lang_estimate }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., minority_sim_results, }\DataTypeTok{by=}\StringTok{"id"}\NormalTok{) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{language=}\KeywordTok{recode}\NormalTok{(location, }\StringTok{"Bolivia"}\NormalTok{ =}\StringTok{ "Quechua"}\NormalTok{, }\StringTok{"US"}\NormalTok{ =}\StringTok{ "Spanish"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(., }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{sim_percen_minority, }\DataTypeTok{fill=}\NormalTok{language)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_density}\NormalTok{(}\DataTypeTok{alpha=}\NormalTok{.}\DecValTok{75}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_fill_manual}\NormalTok{(}\DataTypeTok{values=}\KeywordTok{c}\NormalTok{(}\StringTok{"lightsalmon"}\NormalTok{, }\StringTok{"#CC99FF"}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\NormalTok{id, }\DataTypeTok{scales=}\StringTok{"fixed"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\FloatTok{.25}\NormalTok{),}
                     \DataTypeTok{labels =}\NormalTok{ dropLeadingZero) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_vline}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{xintercept=}\NormalTok{actual_percen_minority),}
            \DataTypeTok{color=}\StringTok{"gray36"}\NormalTok{, }\DataTypeTok{linetype=}\StringTok{"dashed"}\NormalTok{, }\DataTypeTok{size=}\DecValTok{1}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Estimates of minority language quantity"}\NormalTok{) }\OperatorTok{+}
...
\NormalTok{lang_density}
\end{Highlighting}
\end{Shaded}

\includegraphics{validation_results_files/figure-latex/lang simulation plots-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{jpeg}\NormalTok{(}\StringTok{"/Users/megcychosz/Google Drive/biling_CDS/results/figures/min_lang_density_plot.jpeg"}\NormalTok{, }\DataTypeTok{height =} \DecValTok{400}\NormalTok{, }\DataTypeTok{width =} \DecValTok{700}\NormalTok{)}
\NormalTok{lang_density}
...
\CommentTok{#AW added below (correlations for all random sampling simulations and descriptive stats for them)}
\NormalTok{us_cor2 <-}\StringTok{ }\NormalTok{plot_data }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct_at}\NormalTok{(., }\KeywordTok{vars}\NormalTok{(method, id), }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(method, id, percen_span, location) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{spread}\NormalTok{(}\StringTok{"method"}\NormalTok{, }\StringTok{"percen_span"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(location}\OperatorTok{==}\StringTok{'US'}\NormalTok{)}

\NormalTok{us_cor_sim <-}\StringTok{ }\NormalTok{span_sim_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct_at}\NormalTok{(., }\KeywordTok{vars}\NormalTok{(simulation, id), }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(simulation, id, percen_span, location) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{spread}\NormalTok{(}\StringTok{"simulation"}\NormalTok{, }\StringTok{"percen_span"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., us_cor2, }\DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{'id'}\NormalTok{, }\StringTok{'location'}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{id, }\OperatorTok{-}\NormalTok{location)}

\NormalTok{bo_cor2 <-}\StringTok{ }\NormalTok{plot_data }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct_at}\NormalTok{(., }\KeywordTok{vars}\NormalTok{(method, id), }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(method, id, percen_que, location) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{spread}\NormalTok{(}\StringTok{"method"}\NormalTok{, }\StringTok{"percen_que"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(location}\OperatorTok{==}\StringTok{'Bolivia'}\NormalTok{)}

\NormalTok{bo_cor_sim <-}\StringTok{ }\NormalTok{que_sim_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct_at}\NormalTok{(., }\KeywordTok{vars}\NormalTok{(simulation, id), }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(simulation, id, percen_que, location) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{spread}\NormalTok{(}\StringTok{"simulation"}\NormalTok{, }\StringTok{"percen_que"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., bo_cor2, }\DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{'id'}\NormalTok{, }\StringTok{'location'}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{id, }\OperatorTok{-}\NormalTok{location)}

\NormalTok{us_corsimmatrix <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(}\KeywordTok{round}\NormalTok{(}\KeywordTok{cor}\NormalTok{(us_cor_sim),}\DecValTok{2}\NormalTok{))}

\NormalTok{us_corsimmatrix_stats <-}\StringTok{ }\NormalTok{us_corsimmatrix }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_corsim_us =} \KeywordTok{mean}\NormalTok{(us_corsimmatrix}\OperatorTok{$}\NormalTok{complete[}\DecValTok{1}\OperatorTok{:}\NormalTok{nsims]),}
         \DataTypeTok{min_corsim_us =} \KeywordTok{min}\NormalTok{(us_corsimmatrix}\OperatorTok{$}\NormalTok{complete[}\DecValTok{1}\OperatorTok{:}\NormalTok{nsims]),}
         \DataTypeTok{max_corsim_us =} \KeywordTok{max}\NormalTok{(us_corsimmatrix}\OperatorTok{$}\NormalTok{complete[}\DecValTok{1}\OperatorTok{:}\NormalTok{nsims])) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{corsim_stat_us =} \KeywordTok{paste}\NormalTok{(mean_corsim_us,}\StringTok{","}\NormalTok{,min_corsim_us,}\StringTok{"-"}\NormalTok{,max_corsim_us)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(corsim_stat_us)}

\NormalTok{bo_corsimmatrix <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(}\KeywordTok{round}\NormalTok{(}\KeywordTok{cor}\NormalTok{(bo_cor_sim),}\DecValTok{2}\NormalTok{))}

\NormalTok{bo_corsimmatrix_stats <-}\StringTok{ }\NormalTok{bo_corsimmatrix }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_corsim_bo =} \KeywordTok{mean}\NormalTok{(bo_corsimmatrix}\OperatorTok{$}\NormalTok{complete[}\DecValTok{1}\OperatorTok{:}\NormalTok{nsims]),}
         \DataTypeTok{min_corsim_bo =} \KeywordTok{min}\NormalTok{(bo_corsimmatrix}\OperatorTok{$}\NormalTok{complete[}\DecValTok{1}\OperatorTok{:}\NormalTok{nsims]),}
         \DataTypeTok{max_corsim_bo =} \KeywordTok{max}\NormalTok{(bo_corsimmatrix}\OperatorTok{$}\NormalTok{complete[}\DecValTok{1}\OperatorTok{:}\NormalTok{nsims])) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{corsim_stat_bo =} \KeywordTok{paste}\NormalTok{(mean_corsim_bo,}\StringTok{","}\NormalTok{,min_corsim_bo,}\StringTok{"-"}\NormalTok{,max_corsim_bo)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(corsim_stat_bo)}


\CommentTok{# calculate absolute and relative errors (we're only using absolute)}
...
\NormalTok{us_abs_error <-}\StringTok{ }\NormalTok{plot_data }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(location}\OperatorTok{==}\StringTok{'US'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct_at}\NormalTok{(}\KeywordTok{vars}\NormalTok{(id, method, percen_span)) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{spread}\NormalTok{(}\DataTypeTok{key=}\StringTok{'method'}\NormalTok{, }\DataTypeTok{value=}\StringTok{'percen_span'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{abs_error =} \KeywordTok{round}\NormalTok{((}\KeywordTok{abs}\NormalTok{(random }\OperatorTok{-}\StringTok{ }\NormalTok{complete)),}\DecValTok{2}\NormalTok{)) }
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{rel_error_stats=}\KeywordTok{paste}\NormalTok{(avg_rel_error,}\StringTok{"("}\NormalTok{,sd_rel_error,}\StringTok{")"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct}\NormalTok{(rel_error_stats)}
\NormalTok{bo_abs_error <-}\StringTok{ }\NormalTok{plot_data }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(location}\OperatorTok{==}\StringTok{'Bolivia'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct_at}\NormalTok{(}\KeywordTok{vars}\NormalTok{(id, method, percen_que)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{percen_que =} \KeywordTok{round}\NormalTok{(percen_que,}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{spread}\NormalTok{(}\DataTypeTok{key=}\StringTok{'method'}\NormalTok{, }\DataTypeTok{value=}\StringTok{'percen_que'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{abs_error =} \KeywordTok{round}\NormalTok{((}\KeywordTok{abs}\NormalTok{(random }\OperatorTok{-}\StringTok{ }\NormalTok{complete)),}\DecValTok{2}\NormalTok{)) }

\CommentTok{# add correlations to table - will make pretty below}
\NormalTok{us_lang_tbl2 <-}\StringTok{ }\KeywordTok{cbind}\NormalTok{(us_abs_error, us_cor) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., span_sim_child_stats, }\DataTypeTok{by=}\StringTok{'id'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{id=}\KeywordTok{recode}\NormalTok{(id,}\StringTok{"179"}\NormalTok{=}\StringTok{"Spanish-English (179)"}\NormalTok{, }\StringTok{"198-9mo"}\NormalTok{=}\StringTok{"Spanish-English (198)"}\NormalTok{, }\StringTok{"199"}\NormalTok{=}\StringTok{"Spanish-English (199)"}\NormalTok{,}\StringTok{"261-8mo"}\NormalTok{=}\StringTok{"Spanish-English (261)"}\NormalTok{,}\StringTok{"267-12mo"}\NormalTok{=}\StringTok{"Spanish-English (267)"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{relocate}\NormalTok{(}\KeywordTok{c}\NormalTok{(id, random, complete, abs_error, sim_stat_child))}

\NormalTok{bo_lang_tbl2 <-}\StringTok{ }\KeywordTok{cbind}\NormalTok{(bo_abs_error, bo_cor) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., que_sim_child_stats, }\DataTypeTok{by=}\StringTok{'id'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{id =} \KeywordTok{paste}\NormalTok{(}\StringTok{"Quechua-Spanish"}\NormalTok{,}\StringTok{"("}\NormalTok{,id,}\StringTok{")"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{relocate}\NormalTok{(}\KeywordTok{c}\NormalTok{(id, random, complete, abs_error, sim_stat_child)) }

\NormalTok{lang_tbl <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(us_lang_tbl2, bo_lang_tbl2)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(lang_tbl, }\DataTypeTok{caption =} \StringTok{'Minority language estimates by child and annotation method.'}\NormalTok{, }
             \DataTypeTok{booktabs=}\NormalTok{T, }
             \DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
             \DataTypeTok{col.names =} \KeywordTok{c}\NormalTok{(}\StringTok{"Corpus (ID)"}\NormalTok{, }\StringTok{"Random"}\NormalTok{, }\StringTok{"All-day"}\NormalTok{, }\StringTok{"Absolute error"}\NormalTok{, }\StringTok{"n=100 simulations of random sampling Avg. (SD) Range"}\NormalTok{, }\StringTok{"Within-corpus correlation between random and all-day estimates"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DataTypeTok{width =} \StringTok{"5.5cm"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{4}\NormalTok{, }\DataTypeTok{width =} \StringTok{"3cm"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{5}\OperatorTok{:}\DecValTok{6}\NormalTok{, }\DataTypeTok{width =} \StringTok{"4cm"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable_styling}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{add_header_above}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{" "}\NormalTok{ =}\StringTok{ }\DecValTok{1}\NormalTok{, }\StringTok{"Annotation Method"}\NormalTok{ =}\StringTok{ }\DecValTok{2}\NormalTok{, }\StringTok{" "}\NormalTok{ =}\StringTok{ }\DecValTok{3}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{kableExtra}\OperatorTok{::}\KeywordTok{kable_styling}\NormalTok{(}\DataTypeTok{latex_options =} \StringTok{"hold_position"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(., }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{fill=}\NormalTok{language, }\DataTypeTok{y=}\NormalTok{proportion, }\DataTypeTok{x=}\NormalTok{method)) }\OperatorTok{+}
...
\StringTok{  }\CommentTok{#labs(title="Proportion of language categories, by child and annotation method",}
\StringTok{   }\CommentTok{#    subtitle = "Quechua-Spanish corpus                                          Spanish-English corpus") +}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{45}\NormalTok{, }\DataTypeTok{hjust =} \FloatTok{.9}\NormalTok{, }\DataTypeTok{vjust=}\NormalTok{.}\DecValTok{8}\NormalTok{, }\DataTypeTok{size=}\DecValTok{11}\NormalTok{),}
        \DataTypeTok{plot.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{face=}\StringTok{"bold"}\NormalTok{),}
        \DataTypeTok{plot.subtitle =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{color=}\StringTok{'gray50'}\NormalTok{,}\DataTypeTok{hjust =} \FloatTok{.55}\NormalTok{, }\DataTypeTok{face=}\StringTok{'bold'}\NormalTok{, }\DataTypeTok{size=}\DecValTok{14}\NormalTok{),}
        \DataTypeTok{axis.title=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{17}\NormalTok{,}\DataTypeTok{face=}\StringTok{"bold"}\NormalTok{),}
        ...
        \DataTypeTok{strip.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{9}\NormalTok{, }\DataTypeTok{face=}\StringTok{"bold"}\NormalTok{))}
\NormalTok{lang_props}
\end{Highlighting}
\end{Shaded}

\includegraphics{validation_results_files/figure-latex/unnamed-chunk-1-1.pdf}
...
\CommentTok{# now simulate 100 CDS estimates from each child}
\CommentTok{# take however many clips were used to compute the randomly-sampled estimate}
\CommentTok{# then compute the prop. of those that are CDS}
\CommentTok{# repeat 100X}

\CommentTok{# total_reg_annotations refers to the # of clips used to estimate speech register }
\CommentTok{# get that variable}
\NormalTok{random_clips <-}\StringTok{ }\NormalTok{reg_annon }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(method}\OperatorTok{==}\StringTok{'random'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct_at}\NormalTok{(., }\KeywordTok{vars}\NormalTok{(id), }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(id, total_reg_annotations)}

\NormalTok{sim_data <-}\StringTok{ }\NormalTok{reg_annon }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(method}\OperatorTok{==}\StringTok{'complete'}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# we're only sampling from all-day annotations}
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{total_reg_annotations) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# this is the # of all-day clips annotated and we want # of random clips}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., random_clips, }\DataTypeTok{by=}\StringTok{'id'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{replicate}\NormalTok{(}\DecValTok{100}\NormalTok{, ., }\DataTypeTok{simplify =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# simulate 100 collections of random clips}
\StringTok{  }\KeywordTok{map_dfr}\NormalTok{(}\OperatorTok{~}\StringTok{ }\KeywordTok{sample_n}\NormalTok{(., total_reg_annotations), }\DataTypeTok{.id =} \StringTok{"simulation"}\NormalTok{) }\CommentTok{# sample the same # of clips per simulation that were annotated for random sampling}
  
\CommentTok{# now compute the CDS estimate}
\NormalTok{cds_sim_results <-}\StringTok{ }\NormalTok{sim_data }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id, simulation) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(addressee}\OperatorTok{==}\StringTok{'Adult2TargetChild'} \OperatorTok{|}\StringTok{ }\NormalTok{addressee}\OperatorTok{==}\StringTok{'Otherchild2TargetChild'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{n_cds =} \KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# # of CDS clips }
\StringTok{  }\KeywordTok{distinct}\NormalTok{(id, }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{percen_cds =}\NormalTok{ n_cds }\OperatorTok{/}\StringTok{ }\NormalTok{total_reg_annotations)}

\CommentTok{# now some descriptive stats from those results}
\NormalTok{cds_sim_stats <-}\StringTok{ }\NormalTok{cds_sim_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_sim_cds =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(percen_cds),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{sd_sim_cds =} \KeywordTok{round}\NormalTok{(}\KeywordTok{sd}\NormalTok{(percen_cds),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{min_sim_cds =} \KeywordTok{round}\NormalTok{(}\KeywordTok{range}\NormalTok{(percen_cds)[}\DecValTok{1}\NormalTok{],}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{max_sim_cds =} \KeywordTok{round}\NormalTok{(}\KeywordTok{range}\NormalTok{(percen_cds)[}\DecValTok{2}\NormalTok{],}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_stat =} \KeywordTok{paste}\NormalTok{(mean_sim_cds,}\StringTok{"("}\NormalTok{,sd_sim_cds,}\StringTok{")"}\NormalTok{,min_sim_cds,}\StringTok{"-"}\NormalTok{,max_sim_cds)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(id, sim_stat)}

\CommentTok{# now compute the ADS estimate}
\NormalTok{ads_sim_results <-}\StringTok{ }\NormalTok{sim_data }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id, simulation) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(addressee}\OperatorTok{==}\StringTok{'Adult2Others'} \OperatorTok{|}\StringTok{ }\NormalTok{addressee}\OperatorTok{==}\StringTok{'Otherchild2adults'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{n_ads =} \KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# # of CDS clips }
\StringTok{  }\KeywordTok{distinct}\NormalTok{(id, }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{percen_ads =}\NormalTok{ n_ads }\OperatorTok{/}\StringTok{ }\NormalTok{total_reg_annotations)}

\CommentTok{# now some descriptive stats from those results}
\NormalTok{ads_sim_stats <-}\StringTok{ }\NormalTok{ads_sim_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(location) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_sim_ads =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(percen_ads),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{sd_sim_ads =} \KeywordTok{round}\NormalTok{(}\KeywordTok{sd}\NormalTok{(percen_ads),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{min_sim_ads =} \KeywordTok{round}\NormalTok{(}\KeywordTok{range}\NormalTok{(percen_ads)[}\DecValTok{1}\NormalTok{],}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{max_sim_ads =} \KeywordTok{round}\NormalTok{(}\KeywordTok{range}\NormalTok{(percen_ads)[}\DecValTok{2}\NormalTok{],}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_stat_ads =} \KeywordTok{paste}\NormalTok{(mean_sim_ads,}\StringTok{"("}\NormalTok{,sd_sim_ads,}\StringTok{")"}\NormalTok{,min_sim_ads,}\StringTok{"-"}\NormalTok{,max_sim_ads)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(location, sim_stat_ads)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#cds alone}
\NormalTok{cds_density <-}\StringTok{ }\NormalTok{o3 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(method}\OperatorTok{==}\StringTok{'random'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{random_percencds_estimate=}\NormalTok{percen_cds) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# get the actual cds estimate from random sampling}
\StringTok{  }\KeywordTok{select}\NormalTok{(id, random_percencds_estimate) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., cds_sim_results, }\DataTypeTok{by=}\StringTok{"id"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{id=}\KeywordTok{recode}\NormalTok{(id,}\StringTok{"198-9mo"}\NormalTok{=}\StringTok{"198"}\NormalTok{,}\StringTok{"261-8mo"}\NormalTok{=}\StringTok{"261"}\NormalTok{,}\StringTok{"267-12mo"}\NormalTok{=}\StringTok{"267"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ggplot}\NormalTok{(., }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{percen_cds)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_density}\NormalTok{(}\DataTypeTok{fill=}\StringTok{"antiquewhite"}\NormalTok{, }\DataTypeTok{color=}\StringTok{'gray57'}\NormalTok{,}\DataTypeTok{alpha=}\NormalTok{.}\DecValTok{75}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\NormalTok{id, }\DataTypeTok{scales=}\StringTok{"fixed"}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\FloatTok{.25}\NormalTok{),}
                     \DataTypeTok{labels =}\NormalTok{ dropLeadingZero) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_vline}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{xintercept=}\NormalTok{random_percencds_estimate),}
            \DataTypeTok{color=}\StringTok{"chocolate2"}\NormalTok{, }\DataTypeTok{linetype=}\StringTok{"dashed"}\NormalTok{, }\DataTypeTok{size=}\DecValTok{1}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Estimates of child-directed speech quantity"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Density"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{8}\NormalTok{),}
      \DataTypeTok{axis.title=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{17}\NormalTok{,}\DataTypeTok{face=}\StringTok{"bold"}\NormalTok{))}
...
\includegraphics{validation_results_files/figure-latex/simulation density plots-1.pdf}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(method}\OperatorTok{==}\StringTok{'random'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{random_percencds_estimate=}\NormalTok{percen_cds) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# get the actual cds estimate from random sampling}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{random_percenads_estimate=}\NormalTok{percen_ads) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# get the actual ads estimate from random sampling}
...
\StringTok{  }\KeywordTok{geom_density}\NormalTok{(}\DataTypeTok{alpha=}\NormalTok{.}\DecValTok{75}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_fill_manual}\NormalTok{(}\DataTypeTok{values=}\KeywordTok{c}\NormalTok{(}\StringTok{"lightsalmon"}\NormalTok{, }\StringTok{"skyblue1"}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\NormalTok{id, }\DataTypeTok{scales =} \StringTok{"fixed"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\FloatTok{.25}\NormalTok{),}
                     \DataTypeTok{labels =}\NormalTok{ dropLeadingZero) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_vline}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{xintercept=}\NormalTok{random_percenads_estimate),}
            \DataTypeTok{color=}\StringTok{"indianred3"}\NormalTok{, }\DataTypeTok{linetype=}\StringTok{"dashed"}\NormalTok{, }\DataTypeTok{size=}\NormalTok{.}\DecValTok{5}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\KeywordTok{geom_vline}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{xintercept=}\NormalTok{random_percencds_estimate),}
            \DataTypeTok{color=}\StringTok{"dodgerblue3"}\NormalTok{, }\DataTypeTok{linetype=}\StringTok{"dashed"}\NormalTok{, }\DataTypeTok{size=}\NormalTok{.}\DecValTok{5}\NormalTok{) }\OperatorTok{+}
\StringTok{    }\CommentTok{#geom_vline(aes(xintercept=avg_percen_ads),}
\StringTok{            }\CommentTok{#color="indianred3", linetype="solid", size=.5) +}
\StringTok{    }\CommentTok{#geom_vline(aes(xintercept=avg_percen_cds),}
\StringTok{            }\CommentTok{#color="dodgerblue3", linetype="solid", size=.5) +}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Speech register estimates"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Density"}\NormalTok{) }\OperatorTok{+}
...
\includegraphics{validation_results_files/figure-latex/simulation density plots-2.pdf}
...
\CommentTok{# also do a correlation for both corpora}
\NormalTok{cds_cors_all <-}\StringTok{ }\NormalTok{cds_plot_data }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(., }\KeywordTok{paste}\NormalTok{(}\StringTok{"r="}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{cor.test}\NormalTok{(complete, random)}\OperatorTok{$}\NormalTok{estimate,}\DecValTok{2}\NormalTok{),}\StringTok{","}\NormalTok{,}\StringTok{"p="}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{cor.test}\NormalTok{(complete, random)}\OperatorTok{$}\NormalTok{p.value,}\DecValTok{2}\NormalTok{)))}

\CommentTok{#AW added below (correlations for cds random sampling simulations and descriptive stats for them)}
\NormalTok{cds_cor_sim <-}\StringTok{ }\NormalTok{cds_sim_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct_at}\NormalTok{(., }\KeywordTok{vars}\NormalTok{(simulation, id), }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(simulation, id, percen_cds, location) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{spread}\NormalTok{(}\StringTok{"simulation"}\NormalTok{, }\StringTok{"percen_cds"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., cds_plot_data, }\DataTypeTok{by=}\KeywordTok{c}\NormalTok{(}\StringTok{'id'}\NormalTok{, }\StringTok{'location'}\NormalTok{))}
  
\NormalTok{cds_cor_sim_us <-}\StringTok{ }\NormalTok{cds_cor_sim }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(location}\OperatorTok{==}\StringTok{'US'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{id, }\OperatorTok{-}\NormalTok{location, }\OperatorTok{-}\NormalTok{gender, }\OperatorTok{-}\NormalTok{num_clips, }\OperatorTok{-}\NormalTok{percen_ofallclips_drawn)}

\NormalTok{cds_cor_sim_bo <-}\StringTok{ }\NormalTok{cds_cor_sim }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(location}\OperatorTok{==}\StringTok{'Bolivia'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{id, }\OperatorTok{-}\NormalTok{location, }\OperatorTok{-}\NormalTok{gender, }\OperatorTok{-}\NormalTok{num_clips, }\OperatorTok{-}\NormalTok{percen_ofallclips_drawn)}
\NormalTok{  cds_cor_sim_bo[}\KeywordTok{is.na}\NormalTok{(cds_cor_sim_bo)] <-}\StringTok{ }\DecValTok{0} \CommentTok{#replace NA with 0 }

\NormalTok{cds_corsimmatrix_us <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(}\KeywordTok{round}\NormalTok{(}\KeywordTok{cor}\NormalTok{(cds_cor_sim_us),}\DecValTok{2}\NormalTok{))}
\NormalTok{cds_corsimmatrix_bo <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(}\KeywordTok{round}\NormalTok{(}\KeywordTok{cor}\NormalTok{(cds_cor_sim_bo),}\DecValTok{2}\NormalTok{))}

\NormalTok{cds_corsimstats_us <-}\StringTok{ }\NormalTok{cds_corsimmatrix_us }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_corsim_cds_us =} \KeywordTok{mean}\NormalTok{(cds_corsimmatrix_us}\OperatorTok{$}\NormalTok{complete[}\DecValTok{1}\OperatorTok{:}\NormalTok{nsims]),}
         \DataTypeTok{min_corsim_cds_us =} \KeywordTok{min}\NormalTok{(cds_corsimmatrix_us}\OperatorTok{$}\NormalTok{complete[}\DecValTok{1}\OperatorTok{:}\NormalTok{nsims]),}
         \DataTypeTok{max_corsim_cds_us =} \KeywordTok{max}\NormalTok{(cds_corsimmatrix_us}\OperatorTok{$}\NormalTok{complete[}\DecValTok{1}\OperatorTok{:}\NormalTok{nsims])) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{corsim_stat_cds_us =} \KeywordTok{paste}\NormalTok{(mean_corsim_cds_us,}\StringTok{","}\NormalTok{,min_corsim_cds_us,}\StringTok{"-"}\NormalTok{,max_corsim_cds_us)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(corsim_stat_cds_us)}

\NormalTok{cds_corsimstats_bo <-}\StringTok{ }\NormalTok{cds_corsimmatrix_bo }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_corsim_cds_bo =} \KeywordTok{mean}\NormalTok{(cds_corsimmatrix_bo}\OperatorTok{$}\NormalTok{complete[}\DecValTok{1}\OperatorTok{:}\NormalTok{nsims]),}
         \DataTypeTok{min_corsim_cds_bo =} \KeywordTok{min}\NormalTok{(cds_corsimmatrix_bo}\OperatorTok{$}\NormalTok{complete[}\DecValTok{1}\OperatorTok{:}\NormalTok{nsims]),}
         \DataTypeTok{max_corsim_cds_bo =} \KeywordTok{max}\NormalTok{(cds_corsimmatrix_bo}\OperatorTok{$}\NormalTok{complete[}\DecValTok{1}\OperatorTok{:}\NormalTok{nsims])) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{corsim_stat_cds_bo =} \KeywordTok{paste}\NormalTok{(mean_corsim_cds_bo,}\StringTok{","}\NormalTok{,min_corsim_cds_bo,}\StringTok{"-"}\NormalTok{,max_corsim_cds_bo)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(corsim_stat_cds_bo)}
...
\CommentTok{# calculate absolute and relative errors}
...
\NormalTok{cds_abs_error <-}\StringTok{ }\NormalTok{o3 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\CommentTok{#summarize(avg=mean(percen_cds)) %>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(id,method,percen_cds,location) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{spread}\NormalTok{(}\DataTypeTok{key=}\StringTok{'method'}\NormalTok{, }\DataTypeTok{value=}\StringTok{'percen_cds'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{abs_error =} \KeywordTok{round}\NormalTok{(}\KeywordTok{abs}\NormalTok{(random }\OperatorTok{-}\StringTok{ }\NormalTok{complete),}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\CommentTok{#mutate(avg_rel_error = round(mean(relative_error),2),}
\StringTok{  }\CommentTok{#       sd_rel_error = round(sd(relative_error),2),}
\StringTok{  }\CommentTok{#       rel_error_stats=paste(avg_rel_error,"(",sd_rel_error,")")) %>%}
\StringTok{  }\KeywordTok{distinct}\NormalTok{(abs_error, }\DataTypeTok{.keep_all =}\NormalTok{ T)}



\CommentTok{# add correlations and simulated stats to table - will make pretty below}
\NormalTok{final_reg_tbl <-}\StringTok{ }\NormalTok{cds_abs_error }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., cds_cors, }\DataTypeTok{by=}\StringTok{'location'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., cds_sim_stats, }\DataTypeTok{by=}\StringTok{'id'}\NormalTok{)}
...
\StringTok{  }\KeywordTok{relocate}\NormalTok{(corpus_id, random, complete, abs_error, sim_stat)}
  


\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(final_reg_tbl2, }\DataTypeTok{caption =} \StringTok{'Target child-directed speech estimates by child and annotation method.'}\NormalTok{, }
             \DataTypeTok{booktabs=}\NormalTok{T, }
             \DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
             \DataTypeTok{col.names =} \KeywordTok{c}\NormalTok{(}\StringTok{"Corpus (ID)"}\NormalTok{, }\StringTok{"Random"}\NormalTok{, }\StringTok{"All-day"}\NormalTok{, }\StringTok{"Absolute error"}\NormalTok{, }\StringTok{"n=100 simulations of random sampling Avg. (SD) Range"}\NormalTok{, }\StringTok{"Within-corpus correlation between random and all-day estimates"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# "}
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DataTypeTok{width =} \StringTok{"4cm"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# force column headers onto two rows}
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{4}\NormalTok{, }\DataTypeTok{width =} \StringTok{"3cm"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{5}\OperatorTok{:}\DecValTok{6}\NormalTok{, }\DataTypeTok{width =} \StringTok{"4cm"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable_styling}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{add_header_above}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{" "}\NormalTok{ =}\StringTok{ }\DecValTok{1}\NormalTok{, }\StringTok{"Annotation Method"}\NormalTok{ =}\StringTok{ }\DecValTok{2}\NormalTok{, }\StringTok{" "}\NormalTok{ =}\StringTok{ }\DecValTok{3}\NormalTok{)) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{distinct}\NormalTok{(rel_error_stats)}
\NormalTok{ads_abs_error <-}\StringTok{ }\NormalTok{o3 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(method, location, id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{avg=}\KeywordTok{mean}\NormalTok{(percen_ads)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{spread}\NormalTok{(}\DataTypeTok{key=}\StringTok{'method'}\NormalTok{, }\DataTypeTok{value=}\StringTok{'avg'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{abs_error =}\NormalTok{ (}\KeywordTok{abs}\NormalTok{(random }\OperatorTok{-}\StringTok{ }\NormalTok{complete))) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(location) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{avg_abs_error =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(abs_error),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{sd_abs_error =} \KeywordTok{round}\NormalTok{(}\KeywordTok{sd}\NormalTok{(abs_error),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{abs_error_stats=}\KeywordTok{paste}\NormalTok{(avg_abs_error,}\StringTok{"("}\NormalTok{,sd_abs_error,}\StringTok{")"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct}\NormalTok{(abs_error_stats)}

\CommentTok{# add correlations to table - will make pretty below}
\NormalTok{final_reg_tbl <-}\StringTok{ }\NormalTok{reg_tbl }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., ads_cors, }\DataTypeTok{by=}\StringTok{'location'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., ads_abs_error, }\DataTypeTok{by=}\StringTok{'location'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., ads_sim_stats, }\DataTypeTok{by=}\StringTok{'location'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{relocate}\NormalTok{(location, random, complete, abs_error_stats, sim_stat_ads)}
...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(final_reg_tbl, }\DataTypeTok{caption =} \StringTok{'Average adult-directed speech estimates by corpus and annotation method.'}\NormalTok{, }
             \DataTypeTok{booktabs=}\NormalTok{T, }
             \DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
             \DataTypeTok{col.names =} \KeywordTok{c}\NormalTok{(}\StringTok{"Corpus"}\NormalTok{, }\StringTok{"Random"}\NormalTok{, }\StringTok{"All-day"}\NormalTok{, }\StringTok{"Average absolute error (SD)"}\NormalTok{, }\StringTok{"n=100 simulations of random sampling Avg. (SD) Range"}\NormalTok{,  }\StringTok{"Correlation between estimates"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DataTypeTok{width =} \StringTok{"3.5cm"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{4}\NormalTok{, }\DataTypeTok{width =} \StringTok{"3cm"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{5}\OperatorTok{:}\DecValTok{6}\NormalTok{, }\DataTypeTok{width =} \StringTok{"4cm"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable_styling}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{add_header_above}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{" "}\NormalTok{ =}\StringTok{ }\DecValTok{1}\NormalTok{, }\StringTok{"Annotation Method"}\NormalTok{ =}\StringTok{ }\DecValTok{2}\NormalTok{, }\StringTok{" "}\NormalTok{ =}\StringTok{ }\DecValTok{3}\NormalTok{)) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{'annotation method'}\NormalTok{) }\OperatorTok{+}
\StringTok{   }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{subtitle =} \StringTok{"Quechua-Spanish corpus                   Spanish-English corpus"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\CommentTok{#labs(title="Proportion of speech register categories, by child and annotation method",}
\StringTok{       }\CommentTok{#subtitle = "Quechua-Spanish corpus                                       Spanish-English corpus") +}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{45}\NormalTok{, }\DataTypeTok{hjust =} \FloatTok{.9}\NormalTok{, }\DataTypeTok{vjust=}\NormalTok{.}\DecValTok{8}\NormalTok{, }\DataTypeTok{size=}\DecValTok{11}\NormalTok{),}
        \DataTypeTok{plot.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{face=}\StringTok{"bold"}\NormalTok{),}
        \DataTypeTok{plot.subtitle =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{color=}\StringTok{'gray50'}\NormalTok{,}\DataTypeTok{hjust =} \FloatTok{.55}\NormalTok{, }\DataTypeTok{face=}\StringTok{'bold'}\NormalTok{, }\DataTypeTok{size=}\DecValTok{14}\NormalTok{),}
...
\includegraphics{validation_results_files/figure-latex/unnamed-chunk-2-1.pdf}
...
\NormalTok{ques <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\StringTok{"id"}\NormalTok{=}\KeywordTok{c}\NormalTok{(}\StringTok{"179"}\NormalTok{, }\StringTok{"198-9mo"}\NormalTok{, }\StringTok{"199"}\NormalTok{, }\StringTok{"261-8mo"}\NormalTok{, }\StringTok{"267-12mo"}\NormalTok{), }
                   \StringTok{"ques_est"}\NormalTok{=}\KeywordTok{c}\NormalTok{(}\StringTok{".74"}\NormalTok{, }\StringTok{".55"}\NormalTok{, }\StringTok{".95"}\NormalTok{, }\StringTok{".73"}\NormalTok{, }\StringTok{".87"}\NormalTok{))}
...
\StringTok{  }\KeywordTok{spread}\NormalTok{(}\StringTok{"method"}\NormalTok{, }\StringTok{"percen_span"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., span_sim_child_stats, }\DataTypeTok{by=}\StringTok{'id'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{relocate}\NormalTok{(id, random, complete, sim_stat_child)}

\CommentTok{# compute correlations}
\NormalTok{ques_random_cors <-}\StringTok{ }\NormalTok{ques_tbl }\OperatorTok{%>%}\StringTok{ }\CommentTok{# random sampling}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ques_est =} \KeywordTok{as.numeric}\NormalTok{(ques_est)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(., }\KeywordTok{paste}\NormalTok{(}\StringTok{"r="}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{cor.test}\NormalTok{(ques_est, random)}\OperatorTok{$}\NormalTok{estimate,}\DecValTok{3}\NormalTok{),}\StringTok{","}\NormalTok{,}\StringTok{"p="}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{cor.test}\NormalTok{(ques_est, random)}\OperatorTok{$}\NormalTok{p.value,}\DecValTok{3}\NormalTok{)))}
\NormalTok{ques_complete_cors <-}\StringTok{ }\NormalTok{ques_tbl }\OperatorTok{%>%}\StringTok{ }\CommentTok{# all-day sampling}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ques_est =} \KeywordTok{as.numeric}\NormalTok{(ques_est)) }\OperatorTok{%>%}
...
\NormalTok{ques_random_cors_}\DecValTok{4}\NormalTok{ <-}\StringTok{ }\NormalTok{ques_tbl }\OperatorTok{%>%}\StringTok{ }\CommentTok{# random sampling excluding participant 179 who completed at 28 months}
\StringTok{  }\KeywordTok{filter}\NormalTok{(id}\OperatorTok{!=}\StringTok{'179'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ques_est =} \KeywordTok{as.numeric}\NormalTok{(ques_est)) }\OperatorTok{%>%}
...
\NormalTok{ques_complete_cors_}\DecValTok{4}\NormalTok{ <-}\StringTok{ }\NormalTok{ques_tbl }\OperatorTok{%>%}\StringTok{ }\CommentTok{# all-day sampling excluding participant 179 who completed at 28 months}
\StringTok{  }\KeywordTok{filter}\NormalTok{(id}\OperatorTok{!=}\StringTok{'179'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ques_est =} \KeywordTok{as.numeric}\NormalTok{(ques_est)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(., }\KeywordTok{paste}\NormalTok{(}\StringTok{"r="}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{cor.test}\NormalTok{(ques_est, complete)}\OperatorTok{$}\NormalTok{estimate,}\DecValTok{2}\NormalTok{),}\StringTok{","}\NormalTok{,}\StringTok{"p="}\NormalTok{,}\KeywordTok{round}\NormalTok{(}\KeywordTok{cor.test}\NormalTok{(ques_est, complete)}\OperatorTok{$}\NormalTok{p.value,}\DecValTok{2}\NormalTok{)))}
...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(ques_tbl, }\DataTypeTok{caption =} \StringTok{'Spanish language estimates in U.S. corpus, by child and estimation method.'}\NormalTok{, }
             \DataTypeTok{booktabs=}\NormalTok{T, }
             \DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
             \DataTypeTok{col.names =} \KeywordTok{c}\NormalTok{(}\StringTok{"Child ID"}\NormalTok{, }\StringTok{"Random"}\NormalTok{, }\StringTok{"All-day"}\NormalTok{, }\StringTok{"n=100 simulations of random sampling Avg. (SD) Range"}\NormalTok{, }\StringTok{"Parental Questionnaire"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{4}\OperatorTok{:}\DecValTok{5}\NormalTok{, }\DataTypeTok{width =} \StringTok{"4cm"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable_styling}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{add_header_above}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{" "}\NormalTok{ =}\StringTok{ }\DecValTok{1}\NormalTok{, }\StringTok{"From daylong recording"}\NormalTok{ =}\StringTok{ }\DecValTok{3}\NormalTok{, }\StringTok{" "}\NormalTok{ =}\StringTok{ }\DecValTok{1}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{kableExtra}\OperatorTok{::}\KeywordTok{kable_styling}\NormalTok{(}\DataTypeTok{latex_options =} \StringTok{"hold_position"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{reg_annon2 <-}\StringTok{ }\NormalTok{data_annon }\OperatorTok{%>%}
...
\NormalTok{span_cds_tbl <-}\StringTok{ }\NormalTok{reg_annon2 }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id, method) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{relocate}\NormalTok{(id, random, complete) }
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# simulate 100 estimates from random samples}
\CommentTok{# total_cds_annotations refers to the # of clips used to estimate CDS*spanish  }
\CommentTok{# what prop. of totalCDS are spoken in Spanish?}
\NormalTok{random_cds_clips <-}\StringTok{ }\NormalTok{reg_annon2 }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{distinct_at}\NormalTok{(., }\KeywordTok{vars}\NormalTok{(id), }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(id, total_cds_annotations)}

\NormalTok{cdsspan_sim_data <-}\StringTok{ }\NormalTok{reg_annon2 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(method}\OperatorTok{==}\StringTok{'complete'} \OperatorTok{&}\StringTok{ }\NormalTok{location}\OperatorTok{==}\StringTok{'US'}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# we're only sampling from all-day annotations}
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{total_cds_annotations) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# this is the # of all-day clips annotated and we want # of random clips}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., random_cds_clips, }\DataTypeTok{by=}\StringTok{'id'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{replicate}\NormalTok{(}\DecValTok{100}\NormalTok{, ., }\DataTypeTok{simplify =} \OtherTok{FALSE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# simulate 100 collections of random clips}
\StringTok{  }\KeywordTok{map_dfr}\NormalTok{(}\OperatorTok{~}\StringTok{ }\KeywordTok{sample_n}\NormalTok{(., total_cds_annotations), }\DataTypeTok{.id =} \StringTok{"simulation"}\NormalTok{) }\CommentTok{# sample the same # of clips per simulation that were annotated for random sampling}

\CommentTok{# now compute the CDS*spanish estimate}
\NormalTok{cdsspan_sim_results <-}\StringTok{ }\NormalTok{cdsspan_sim_data }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id, simulation) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(language}\OperatorTok{==}\StringTok{'Spanish'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{n_cdsspan =} \KeywordTok{n}\NormalTok{()) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# # of spanish clips amongst these CDS clips}
\StringTok{  }\KeywordTok{distinct}\NormalTok{(id, }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{percen_cdsspan =}\NormalTok{ n_cdsspan }\OperatorTok{/}\StringTok{ }\NormalTok{total_cds_annotations)}

\CommentTok{# now some descriptive stats from those results}
\NormalTok{cdsspan_sim_stats <-}\StringTok{ }\NormalTok{cdsspan_sim_results }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_sim_cdsspan =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(percen_cdsspan),}\DecValTok{2}\NormalTok{),}
            \DataTypeTok{sd_sim_cdsspan =} \KeywordTok{round}\NormalTok{(}\KeywordTok{sd}\NormalTok{(percen_cdsspan),}\DecValTok{2}\NormalTok{),}
            \DataTypeTok{min_sim_cdsspan =} \KeywordTok{round}\NormalTok{(}\KeywordTok{range}\NormalTok{(percen_cdsspan)[}\DecValTok{1}\NormalTok{],}\DecValTok{2}\NormalTok{),}
            \DataTypeTok{max_sim_cdsspan =} \KeywordTok{round}\NormalTok{(}\KeywordTok{range}\NormalTok{(percen_cdsspan)[}\DecValTok{2}\NormalTok{],}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_stat_cdsspan =} \KeywordTok{paste}\NormalTok{(mean_sim_cdsspan,}\StringTok{"("}\NormalTok{,sd_sim_cdsspan,}\StringTok{")"}\NormalTok{,min_sim_cdsspan,}\StringTok{"-"}\NormalTok{,max_sim_cdsspan)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(id, sim_stat_cdsspan)}

\CommentTok{# now combine the simulated data with the span*cds table}
\NormalTok{span_cds_tbl2 <-}\StringTok{ }\NormalTok{span_cds_tbl }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{merge}\NormalTok{(., cdsspan_sim_stats, }\DataTypeTok{by=}\StringTok{'id'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{relocate}\NormalTok{(id, random, complete, sim_stat_cdsspan)}


\CommentTok{# create table}
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(span_cds_tbl2, }\DataTypeTok{caption =} \StringTok{'Spanish language in child-directed speech }\CharTok{\textbackslash{}n}\StringTok{ estimates in U.S. corpus, by child and estimation method.'}\NormalTok{, }
             \DataTypeTok{booktabs=}\NormalTok{T, }
             \DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
             \DataTypeTok{col.names =} \KeywordTok{c}\NormalTok{(}\StringTok{"Child ID"}\NormalTok{, }\StringTok{"Random"}\NormalTok{, }\StringTok{"All-day"}\NormalTok{, }\StringTok{"n=100 simulations of random sampling Avg. (SD) Range"}\NormalTok{, }\StringTok{"Parental Questionnaire"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{, }\DataTypeTok{width =} \StringTok{"2cm"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{4}\OperatorTok{:}\DecValTok{5}\NormalTok{, }\DataTypeTok{width =} \StringTok{"4cm"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable_styling}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{add_header_above}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{" "}\NormalTok{ =}\StringTok{ }\DecValTok{1}\NormalTok{, }\StringTok{"From daylong recording"}\NormalTok{ =}\StringTok{ }\DecValTok{3}\NormalTok{, }\StringTok{" "}\NormalTok{ =}\StringTok{ }\DecValTok{1}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{kableExtra}\OperatorTok{::}\KeywordTok{kable_styling}\NormalTok{(}\DataTypeTok{latex_options =} \StringTok{"hold_position"}\NormalTok{)}
...
\caption{\label{tab:cds-by-span}Spanish language in child-directed speech 
 estimates in U.S. corpus, by child and estimation method.}
\centering
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedleft\arraybackslash}p{2cm}>{\raggedright\arraybackslash}p{4cm}>{\raggedright\arraybackslash}p{4cm}}
\toprule
\multicolumn{1}{c}{ } & \multicolumn{3}{c}{From daylong recording} & \multicolumn{1}{c}{ } \\
\cmidrule(l{3pt}r{3pt}){2-4}
Child ID & Random & All-day & n=100 simulations of random sampling Avg. (SD) Range & Parental Questionnaire\\
...
\StringTok{  }\KeywordTok{merge}\NormalTok{(., per_ann, }\DataTypeTok{by=}\StringTok{'id'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct}\NormalTok{(id, }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}
\KeywordTok{ggplot}\NormalTok{(., }\KeywordTok{aes}\NormalTok{(}\KeywordTok{as.numeric}\NormalTok{(random), }\KeywordTok{as.numeric}\NormalTok{(ques_est))) }\OperatorTok{+}
...
\begin{Highlighting}[]
\NormalTok{reg_annon <-}\StringTok{ }\NormalTok{data_annon }\OperatorTok{%>%}
\StringTok{  }\CommentTok{#filter(addressee=='Adult2TargetChild' | }
\StringTok{   }\CommentTok{#        addressee=='Otherchild2TargetChild' | }
\StringTok{    }\CommentTok{#       addressee=='Adult2Others' | }
\StringTok{     }\CommentTok{#      addressee=='Otherchild2adults' | }
\StringTok{      }\CommentTok{#     addressee=='Adult2OtherChild' | }
\StringTok{       }\CommentTok{#    addressee=='Otherchild2OtherChild') %>% # option to omit clips where there is language but register is unsure}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id, method) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct_at}\NormalTok{(., }\KeywordTok{vars}\NormalTok{(file_name, addressee), }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# don't record the same register 2x in a single clip}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{total_reg_annotations =} \KeywordTok{NROW}\NormalTok{(file_name)) }\CommentTok{# N of register annotations made; distinct from N }
\CommentTok{# of speech clips since one clip could contain multiple distinct registers}

\NormalTok{reg_annon}\OperatorTok{$}\NormalTok{id <-}\StringTok{ }\NormalTok{plyr}\OperatorTok{::}\KeywordTok{mapvalues}\NormalTok{(reg_annon}\OperatorTok{$}\NormalTok{id, }
...
\NormalTok{cds_rolling <-}\StringTok{ }\NormalTok{reg_annon }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(method}\OperatorTok{!=}\StringTok{'complete'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(file_name) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# scramble the register annotations}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{annotation_num =} \KeywordTok{as.numeric}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\KeywordTok{n}\NormalTok{())) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# where n is the total # of speech register annotations}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(annotation_num) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{cds_cts=}\KeywordTok{recode}\NormalTok{(addressee, }\StringTok{"Adult2TargetChild"}\NormalTok{=}\StringTok{"1"}\NormalTok{, }\StringTok{"Otherchild2TargetChild"}\NormalTok{=}\StringTok{"1"}\NormalTok{, }
                        \StringTok{"Otherchild2OtherChild"}\NormalTok{=}\StringTok{"0"}\NormalTok{, }\StringTok{"Otherchild2adults"}\NormalTok{=}\StringTok{"0"}\NormalTok{, }
                        \StringTok{"Adult2OtherChild"}\NormalTok{=}\StringTok{"0"}\NormalTok{,  }\StringTok{"Adult2Others"}\NormalTok{=}\StringTok{"0"}\NormalTok{, }\StringTok{"Otherchild2unsure"}\NormalTok{=}\StringTok{"0"}\NormalTok{,}
                        \StringTok{"Adult2unsure"}\NormalTok{=}\StringTok{"0"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{cds_cts =} \KeywordTok{as.numeric}\NormalTok{(cds_cts)) }\OperatorTok{%>%}\StringTok{ }
...
\CommentTok{# -------- now do the same for the all-day annotation  method -----------}
\CommentTok{# now do the same but for the complete data}
\NormalTok{cds_rolling_complete <-}\StringTok{ }\NormalTok{reg_annon }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(method}\OperatorTok{!=}\StringTok{'random'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(file_name) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# scramble the register annotations}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{annotation_num =} \KeywordTok{as.numeric}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\KeywordTok{n}\NormalTok{())) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# where n is the total # of speech register annotations}
...
\CommentTok{# running binomial confidence interval (wilson)}
\NormalTok{cds_rolling_complete2 <-}\StringTok{ }\NormalTok{cds_rolling_complete }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id, annotation_num) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# group by id and sample size}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(annotation_num) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{cis =} \KeywordTok{binom.confint}\NormalTok{(cds_running_cts, annotation_num, }\DataTypeTok{methods =} \StringTok{'wilson'}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{.95}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., cds_rolling_complete, }\DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{'id'}\NormalTok{, }\StringTok{'annotation_num'}\NormalTok{)) }
...
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"# of speech register annotations"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
...
\StringTok{ }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{12}\NormalTok{),}
   \DataTypeTok{axis.text=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{8}\NormalTok{),}
      \DataTypeTok{axis.title=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{17}\NormalTok{,}\DataTypeTok{face=}\StringTok{"bold"}\NormalTok{),}
      \DataTypeTok{legend.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{15}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{caption =} \StringTok{"'# of speech register annotations' includes 'unsure' speech register annotations."}\NormalTok{)}
...
\NormalTok{lang_annon <-}\StringTok{ }\NormalTok{data_annon }\OperatorTok{%>%}
\StringTok{  }\CommentTok{#filter(language=='Mixed' | language=='Spanish' | language=='English/Quechua') %>% # option to omit unsure annotationse}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id, method) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{distinct_at}\NormalTok{(., }\KeywordTok{vars}\NormalTok{(file_name, language), }\DataTypeTok{.keep_all =}\NormalTok{ T) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# don't record the same language 2x in the same clip}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{total_lang_annotations =} \KeywordTok{NROW}\NormalTok{(file_name)) }\CommentTok{# N of language annotations made; distinct from N of speech clips since one clip could co}

\NormalTok{lang_annon}\OperatorTok{$}\NormalTok{id <-}\StringTok{ }\NormalTok{plyr}\OperatorTok{::}\KeywordTok{mapvalues}\NormalTok{(lang_annon}\OperatorTok{$}\NormalTok{id, }
                                \DataTypeTok{from=}\KeywordTok{c}\NormalTok{(}\StringTok{"198-9mo"}\NormalTok{, }\StringTok{"261-8mo"}\NormalTok{, }\StringTok{"267-12mo"}\NormalTok{), }
                                \DataTypeTok{to=}\KeywordTok{c}\NormalTok{(}\StringTok{"198"}\NormalTok{, }\StringTok{"261"}\NormalTok{, }\StringTok{"267"}\NormalTok{))}

\CommentTok{# the code below is just for US data, not Bolivia }
\CommentTok{# ---------------------- #}

\NormalTok{span_rolling <-}\StringTok{ }\NormalTok{lang_annon }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(location}\OperatorTok{==}\StringTok{'US'} \OperatorTok{&}\StringTok{ }\NormalTok{method}\OperatorTok{==}\StringTok{'random'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{arrange}\NormalTok{(file_name) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{annotation_num =} \KeywordTok{as.numeric}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\KeywordTok{n}\NormalTok{())) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(annotation_num) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{span_cts=}\KeywordTok{recode}\NormalTok{(language, }\StringTok{"Unsure"}\NormalTok{=}\StringTok{"0"}\NormalTok{, }\StringTok{"English/Quechua"}\NormalTok{=}\StringTok{"0"}\NormalTok{, }\StringTok{"Mixed"}\NormalTok{=}\StringTok{"0"}\NormalTok{, }\StringTok{"Spanish"}\NormalTok{=}\StringTok{"1"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{span_cts =} \KeywordTok{as.numeric}\NormalTok{(span_cts)) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y=}\NormalTok{mean_ci), }\DataTypeTok{color=}\StringTok{'gray40'}\NormalTok{, }\DataTypeTok{size=}\NormalTok{.}\DecValTok{8}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"# of language annotations"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
...
\StringTok{ }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{12}\NormalTok{),}
   \DataTypeTok{axis.text=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{8}\NormalTok{),}
      \DataTypeTok{axis.title=}\KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{17}\NormalTok{,}\DataTypeTok{face=}\StringTok{"bold"}\NormalTok{),}
      \DataTypeTok{legend.title =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{size=}\DecValTok{15}\NormalTok{))  }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{caption =} \StringTok{"'# of language annotations' includes 'unsure' language annotations."}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{que_rolling <-}\StringTok{ }\NormalTok{lang_annon }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(location}\OperatorTok{==}\StringTok{'Bolivia'} \OperatorTok{&}\StringTok{ }\NormalTok{method}\OperatorTok{==}\StringTok{'random'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(file_name) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{annotation_num =} \KeywordTok{as.numeric}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\KeywordTok{n}\NormalTok{())) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(annotation_num) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{que_cts=}\KeywordTok{recode}\NormalTok{(language, }\StringTok{"Unsure"}\NormalTok{=}\StringTok{"0"}\NormalTok{, }\StringTok{"English/Quechua"}\NormalTok{=}\StringTok{"1"}\NormalTok{, }\StringTok{"Mixed"}\NormalTok{=}\StringTok{"0"}\NormalTok{, }\StringTok{"Spanish"}\NormalTok{=}\StringTok{"0"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{que_cts =} \KeywordTok{as.numeric}\NormalTok{(que_cts)) }\OperatorTok{%>%}
...
\CommentTok{# build data sets}
\NormalTok{cds_model_data_firstthird <-}\StringTok{ }\NormalTok{cds_rolling2 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(annotation_num) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{row_number}\NormalTok{() }\OperatorTok{<=}\StringTok{ }\KeywordTok{n}\NormalTok{()}\OperatorTok{*}\NormalTok{.}\DecValTok{33}\NormalTok{) }\CommentTok{# get the bottom 50% of rows from each group}

\NormalTok{cds_model_data_secondthird <-}\StringTok{ }\NormalTok{cds_rolling2 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(annotation_num) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{halfrow =} \KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{n}\NormalTok{()}\OperatorTok{/}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# for a sanity check}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{row_number}\NormalTok{() }\OperatorTok{<}\StringTok{ }\KeywordTok{n}\NormalTok{()}\OperatorTok{*}\NormalTok{.}\DecValTok{66} \OperatorTok{&}\StringTok{ }\KeywordTok{row_number}\NormalTok{() }\OperatorTok{>}\StringTok{ }\KeywordTok{n}\NormalTok{()}\OperatorTok{*}\NormalTok{.}\DecValTok{33}\NormalTok{) }\CommentTok{# get the top 50% of rows from each group}

\NormalTok{cds_model_data_thirdthird <-}\StringTok{ }\NormalTok{cds_rolling2 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(annotation_num) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{halfrow =} \KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{n}\NormalTok{()}\OperatorTok{/}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# for a sanity check}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{row_number}\NormalTok{() }\OperatorTok{>=}\StringTok{ }\KeywordTok{n}\NormalTok{()}\OperatorTok{*}\NormalTok{.}\DecValTok{66}\NormalTok{) }\CommentTok{# get the top 50% of rows from each group}

\NormalTok{cds_model_data_full <-}\StringTok{ }\NormalTok{cds_rolling_complete2 }\OperatorTok{%>%}\StringTok{ }\CommentTok{# all the data from the 'complete' annotation}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(annotation_num)}

\CommentTok{# fit models  }
\NormalTok{cds_model_firstthird <-}\StringTok{ }\NormalTok{cds_model_data_firstthird }\OperatorTok{%>%}
...
\NormalTok{cds_model_secondthird <-}\StringTok{ }\NormalTok{cds_model_data_secondthird }\OperatorTok{%>%}
\StringTok{  }\CommentTok{#filter(roll_sd_cds!='NA') %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ci_range =}\NormalTok{ cis}\OperatorTok{$}\NormalTok{upper }\OperatorTok{-}\StringTok{ }\NormalTok{cis}\OperatorTok{$}\NormalTok{lower) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{lmer}\NormalTok{(ci_range}\OperatorTok{~}\NormalTok{annotation_num }\OperatorTok{+}\StringTok{ }\NormalTok{(}\DecValTok{1}\OperatorTok{|}\NormalTok{id), }\DataTypeTok{data =}\NormalTok{ .) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summary}\NormalTok{()}

\NormalTok{cds_model_thirdthird <-}\StringTok{ }\NormalTok{cds_model_data_thirdthird }\OperatorTok{%>%}
\StringTok{  }\CommentTok{#filter(roll_sd_cds!='NA') %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ci_range =}\NormalTok{ cis}\OperatorTok{$}\NormalTok{upper }\OperatorTok{-}\StringTok{ }\NormalTok{cis}\OperatorTok{$}\NormalTok{lower) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{lmer}\NormalTok{(ci_range}\OperatorTok{~}\NormalTok{annotation_num }\OperatorTok{+}\StringTok{ }\NormalTok{(}\DecValTok{1}\OperatorTok{|}\NormalTok{id), }\DataTypeTok{data =}\NormalTok{ .) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summary}\NormalTok{()}

\NormalTok{cds_model_complete <-}\StringTok{ }\NormalTok{cds_model_data_full }\OperatorTok{%>%}
\StringTok{  }\CommentTok{#filter(roll_sd_cds!='NA') %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ci_range =}\NormalTok{ cis}\OperatorTok{$}\NormalTok{upper }\OperatorTok{-}\StringTok{ }\NormalTok{cis}\OperatorTok{$}\NormalTok{lower) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{lmer}\NormalTok{(ci_range}\OperatorTok{~}\NormalTok{annotation_num }\OperatorTok{+}\StringTok{ }\NormalTok{(}\DecValTok{1}\OperatorTok{|}\NormalTok{id), }\DataTypeTok{data =}\NormalTok{ .) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summary}\NormalTok{()}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# redo data to get the Bolivia and US corpora (more power for stats)}
\NormalTok{span_rolling_all <-}\StringTok{ }\NormalTok{lang_annon }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(method}\OperatorTok{==}\StringTok{'random'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{arrange}\NormalTok{(file_name) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{annotation_num =} \KeywordTok{as.numeric}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\KeywordTok{n}\NormalTok{())) }\OperatorTok{%>%}
...
\CommentTok{# now start all over to get running variance for complete data from Bolivia and US}
\NormalTok{span_rolling_all_complete <-}\StringTok{ }\NormalTok{lang_annon }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(method}\OperatorTok{==}\StringTok{'complete'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{arrange}\NormalTok{(file_name) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{annotation_num =} \KeywordTok{as.numeric}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\KeywordTok{n}\NormalTok{())) }\OperatorTok{%>%}
...
\CommentTok{# running binomial confidence interval (wilson)}
\NormalTok{span_rolling_all_complete2 <-}\StringTok{ }\NormalTok{span_rolling_all_complete }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id, annotation_num) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# group by id and sample size}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(annotation_num) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{cis =} \KeywordTok{binom.confint}\NormalTok{(span_running_cts, annotation_num, }\DataTypeTok{methods =} \StringTok{'wilson'}\NormalTok{, }\DataTypeTok{conf.level =} \FloatTok{.95}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., span_rolling_all_complete, }\DataTypeTok{by =} \KeywordTok{c}\NormalTok{(}\StringTok{'id'}\NormalTok{, }\StringTok{'annotation_num'}\NormalTok{)) }


\CommentTok{# fit the spanish models}
\CommentTok{# make the datasets}
\NormalTok{span_model_data_firstthird <-}\StringTok{ }\NormalTok{span_rolling_all2 }\OperatorTok{%>%}\StringTok{ }\CommentTok{# Bolivia and US; running variance over estimates made via random sampling}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(annotation_num) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{halfrow =} \KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{n}\NormalTok{()}\OperatorTok{/}\DecValTok{2}\NormalTok{))  }\OperatorTok{%>%}\StringTok{ }\CommentTok{# for a sanity check}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{row_number}\NormalTok{() }\OperatorTok{<=}\StringTok{ }\KeywordTok{n}\NormalTok{()}\OperatorTok{*}\NormalTok{.}\DecValTok{33}\NormalTok{)}

\NormalTok{span_model_data_secondthird <-}\StringTok{ }\NormalTok{span_rolling_all2 }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(annotation_num) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{halfrow =} \KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{n}\NormalTok{()}\OperatorTok{/}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# for a sanity check}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{row_number}\NormalTok{() }\OperatorTok{<}\StringTok{ }\KeywordTok{n}\NormalTok{()}\OperatorTok{*}\NormalTok{.}\DecValTok{66} \OperatorTok{&}\StringTok{ }\KeywordTok{row_number}\NormalTok{() }\OperatorTok{>}\StringTok{ }\KeywordTok{n}\NormalTok{()}\OperatorTok{*}\NormalTok{.}\DecValTok{33}\NormalTok{)}
  
\NormalTok{  span_model_data_thirdthird <-}\StringTok{ }\NormalTok{span_rolling_all2 }\OperatorTok{%>%}\StringTok{ }\CommentTok{# Bolivia and US; running variance over estimates made via random sampling}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(annotation_num) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{halfrow =} \KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{n}\NormalTok{()}\OperatorTok{/}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# for a sanity check}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{row_number}\NormalTok{() }\OperatorTok{>=}\StringTok{ }\KeywordTok{n}\NormalTok{()}\OperatorTok{*}\NormalTok{.}\DecValTok{66}\NormalTok{)}

\NormalTok{span_model_data_complete <-}\StringTok{ }\NormalTok{span_rolling_all_complete2 }\OperatorTok{%>%}\StringTok{ }\CommentTok{# Bolivia & US; all the data from the 'all-day' annotation}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(id) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{arrange}\NormalTok{(annotation_num)}

\CommentTok{# fit the models}
\NormalTok{span_model_firstthird <-}\StringTok{ }\NormalTok{span_model_data_firstthird }\OperatorTok{%>%}
...
\NormalTok{span_model_secondthird <-}\StringTok{ }\NormalTok{span_model_data_secondthird }\OperatorTok{%>%}
\StringTok{  }\CommentTok{#filter(roll_sd_span!='NA') %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ci_range =}\NormalTok{ cis}\OperatorTok{$}\NormalTok{upper }\OperatorTok{-}\StringTok{ }\NormalTok{cis}\OperatorTok{$}\NormalTok{lower) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# get the variance}
\StringTok{  }\KeywordTok{lmer}\NormalTok{(ci_range}\OperatorTok{~}\NormalTok{annotation_num }\OperatorTok{+}\StringTok{ }\NormalTok{(}\DecValTok{1}\OperatorTok{|}\NormalTok{id), }\DataTypeTok{data =}\NormalTok{ .) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summary}\NormalTok{()}

\NormalTok{span_model_thirdthird <-}\StringTok{ }\NormalTok{span_model_data_thirdthird }\OperatorTok{%>%}
\StringTok{  }\CommentTok{#filter(roll_sd_span!='NA') %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ci_range =}\NormalTok{ cis}\OperatorTok{$}\NormalTok{upper }\OperatorTok{-}\StringTok{ }\NormalTok{cis}\OperatorTok{$}\NormalTok{lower) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# get the variance}
\StringTok{  }\KeywordTok{lmer}\NormalTok{(ci_range}\OperatorTok{~}\NormalTok{annotation_num }\OperatorTok{+}\StringTok{ }\NormalTok{(}\DecValTok{1}\OperatorTok{|}\NormalTok{id), }\DataTypeTok{data =}\NormalTok{ .) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summary}\NormalTok{()}

\NormalTok{span_model_complete<-}\StringTok{ }\NormalTok{span_model_data_complete }\OperatorTok{%>%}
\StringTok{  }\CommentTok{#filter(roll_sd_span!='NA') %>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{ci_range =}\NormalTok{ cis}\OperatorTok{$}\NormalTok{upper }\OperatorTok{-}\StringTok{ }\NormalTok{cis}\OperatorTok{$}\NormalTok{lower) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# get the variance}
\StringTok{  }\KeywordTok{lmer}\NormalTok{(ci_range}\OperatorTok{~}\NormalTok{annotation_num }\OperatorTok{+}\StringTok{ }\NormalTok{(}\DecValTok{1}\OperatorTok{|}\NormalTok{id), }\DataTypeTok{data =}\NormalTok{ .) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summary}\NormalTok{()}
