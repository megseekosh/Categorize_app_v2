...
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_sim_que =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(percen_que),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{sd_sim_que =} \KeywordTok{round}\NormalTok{(}\KeywordTok{sd}\NormalTok{(percen_que),}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_stat =} \KeywordTok{paste}\NormalTok{(mean_sim_que,}\StringTok{"("}\NormalTok{,sd_sim_que,}\StringTok{")"}\NormalTok{)) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_sim_span =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(percen_span),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{sd_sim_span =} \KeywordTok{round}\NormalTok{(}\KeywordTok{sd}\NormalTok{(percen_span),}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_stat =} \KeywordTok{paste}\NormalTok{(mean_sim_span,}\StringTok{"("}\NormalTok{,sd_sim_span,}\StringTok{")"}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(sim_stat)}
...
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_sim_span =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(percen_span),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{sd_sim_span =} \KeywordTok{round}\NormalTok{(}\KeywordTok{sd}\NormalTok{(percen_span),}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_stat_child =} \KeywordTok{paste}\NormalTok{(mean_sim_span,}\StringTok{"("}\NormalTok{,sd_sim_span,}\StringTok{")"}\NormalTok{)) }\OperatorTok{%>%}
...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(lang_tbl, }\DataTypeTok{caption =} \StringTok{'Average minority language estimates by corpus and annotation method.'}\NormalTok{, }
             \DataTypeTok{booktabs=}\NormalTok{T, }
             \DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
             \DataTypeTok{col.names =} \KeywordTok{c}\NormalTok{(}\StringTok{"Corpus (language)"}\NormalTok{, }\StringTok{"Random"}\NormalTok{, }\StringTok{"All-day"}\NormalTok{, }\StringTok{"Avg. relative error (SD)"}\NormalTok{, }\StringTok{"n=100 simulations of random sampling"}\NormalTok{, }\StringTok{"Correlation between estimates"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DataTypeTok{width =} \StringTok{"4cm"}\NormalTok{) }\OperatorTok{%>%}
...
\centering
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{4cm}ll>{\raggedright\arraybackslash}p{3cm}>{\raggedright\arraybackslash}p{4cm}>{\raggedright\arraybackslash}p{4cm}}
\toprule
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Annotation Method} & \multicolumn{3}{c}{ } \\
\cmidrule(l{3pt}r{3pt}){2-3}
Corpus (language) & Random & All-day & Avg. relative error (SD) & n=100 simulations of random sampling & Correlation between estimates\\
\midrule
Spanish-English (Spanish) & 0.75 ( 0.13 ) & 0.69 ( 0.12 ) & 5.36 ( 4.82 ) & 0.72 ( 0.13 ) & r= 0.96 , p= 0.01\\
Quechua-Spanish (Quechua) & 0.48 ( 0.11 ) & 0.5 ( 0.12 ) & 11.02 ( 4.28 ) & 0.48 ( 0.13 ) & r= 0.9 , p= 0.04\\
\bottomrule
\end{tabular}
\end{table}
...
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_sim_cds =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(percen_cds),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{sd_sim_cds =} \KeywordTok{round}\NormalTok{(}\KeywordTok{sd}\NormalTok{(percen_cds),}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_stat =} \KeywordTok{paste}\NormalTok{(mean_sim_cds,}\StringTok{"("}\NormalTok{,sd_sim_cds,}\StringTok{")"}\NormalTok{)) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_sim_ads =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(percen_ads),}\DecValTok{2}\NormalTok{),}
         \DataTypeTok{sd_sim_ads =} \KeywordTok{round}\NormalTok{(}\KeywordTok{sd}\NormalTok{(percen_ads),}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_stat_ads =} \KeywordTok{paste}\NormalTok{(mean_sim_ads,}\StringTok{"("}\NormalTok{,sd_sim_ads,}\StringTok{")"}\NormalTok{)) }\OperatorTok{%>%}
...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(final_reg_tbl2, }\DataTypeTok{caption =} \StringTok{'Target child-directed speech estimates by child and annotation method.'}\NormalTok{, }
             \DataTypeTok{booktabs=}\NormalTok{T, }
             \DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
             \DataTypeTok{col.names =} \KeywordTok{c}\NormalTok{(}\StringTok{"Corpus (ID)"}\NormalTok{, }\StringTok{"Random"}\NormalTok{, }\StringTok{"All-day"}\NormalTok{, }\StringTok{"Relative error"}\NormalTok{, }\StringTok{"n=100 simulations of random sampling"}\NormalTok{, }\StringTok{"Within-corpus correlation between random and all-day estimates"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# "}
...
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Annotation Method} & \multicolumn{3}{c}{ } \\
\cmidrule(l{3pt}r{3pt}){2-3}
Corpus (ID) & Random & All-day & Relative error & n=100 simulations of random sampling & Within-corpus correlation between random and all-day estimates\\
\midrule
Quechua-Spanish ( 1032 ) & 0.19 & 0.17 & 11.53 & 0.17 ( 0.03 ) & r= 0.64 , p= 0.24\\
Quechua-Spanish ( 1060 ) & 0.12 & 0.07 & 55.09 & 0.07 ( 0.02 ) & r= 0.64 , p= 0.24\\
Quechua-Spanish ( 1075 ) & 0.12 & 0.14 & 12.50 & 0.14 ( 0.03 ) & r= 0.64 , p= 0.24\\
Quechua-Spanish ( 1077 ) & 0.10 & 0.11 & 10.48 & 0.11 ( 0.03 ) & r= 0.64 , p= 0.24\\
Quechua-Spanish ( 1081 ) & 0.13 & 0.05 & 145.09 & 0.05 ( 0.02 ) & r= 0.64 , p= 0.24\\
\addlinespace
Spanish-English ( 179 ) & 0.53 & 0.47 & 13.24 & 0.47 ( 0.04 ) & r= 0.97 , p= 0.01\\
Spanish-English ( 198-9mo ) & 0.65 & 0.66 & 1.09 & 0.66 ( 0.06 ) & r= 0.97 , p= 0.01\\
Spanish-English ( 199 ) & 0.29 & 0.31 & 6.06 & 0.32 ( 0.04 ) & r= 0.97 , p= 0.01\\
Spanish-English ( 261-8mo ) & 0.80 & 0.82 & 2.37 & 0.83 ( 0.03 ) & r= 0.97 , p= 0.01\\
Spanish-English ( 267-12mo ) & 0.40 & 0.47 & 15.23 & 0.47 ( 0.04 ) & r= 0.97 , p= 0.01\\
\bottomrule
\end{tabular}
\end{table}
...
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Annotation Method} & \multicolumn{3}{c}{ } \\
\cmidrule(l{3pt}r{3pt}){2-3}
Corpus & Random & All-day & Average relative error (SD) & n=100 simulations of random sampling & Correlation between estimates\\
\midrule
Quechua-Spanish & 0.42 ( 0.11 ) & 0.48 ( 0.14 ) & 12.17 ( 12.56 ) & 0.48 ( 0.13 ) & r= 0.84 , p= 0.08\\
Spanish-English & 0.27 ( 0.2 ) & 0.27 ( 0.17 ) & 17.57 ( 12.74 ) & 0.27 ( 0.16 ) & r= 0.95 , p= 0.01\\
\bottomrule
\end{tabular}
\end{table}
...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(ques_tbl, }\DataTypeTok{caption =} \StringTok{'Spanish language estimates in U.S. corpus, by child and estimation method.'}\NormalTok{, }
             \DataTypeTok{booktabs=}\NormalTok{T, }
             \DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
             \DataTypeTok{col.names =} \KeywordTok{c}\NormalTok{(}\StringTok{"Child ID"}\NormalTok{, }\StringTok{"Random"}\NormalTok{, }\StringTok{"All-day"}\NormalTok{, }\StringTok{"n=100 simulations of random sampling"}\NormalTok{, }\StringTok{"Parental Questionnaire"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
...
Child ID & Random & All-day & n=100 simulations of random sampling & Parental Questionnaire\\
\midrule
179 & 0.57 & 0.57 & 0.56 ( 0.04 ) & .71\\
198-9mo & 0.87 & 0.78 & 0.78 ( 0.04 ) & .57\\
199 & 0.76 & 0.70 & 0.7 ( 0.03 ) & .94\\
261-8mo & 0.69 & 0.65 & 0.66 ( 0.05 ) & .69\\
267-12mo & 0.92 & 0.92 & 0.92 ( 0.02 ) & .87\\
\bottomrule
\end{tabular}
\end{table}
...
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean_sim_cdsspan =} \KeywordTok{round}\NormalTok{(}\KeywordTok{mean}\NormalTok{(percen_cdsspan),}\DecValTok{2}\NormalTok{),}
            \DataTypeTok{sd_sim_cdsspan =} \KeywordTok{round}\NormalTok{(}\KeywordTok{sd}\NormalTok{(percen_cdsspan),}\DecValTok{2}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{sim_stat_cdsspan =} \KeywordTok{paste}\NormalTok{(mean_sim_cdsspan,}\StringTok{"("}\NormalTok{,sd_sim_cdsspan,}\StringTok{")"}\NormalTok{)) }\OperatorTok{%>%}
...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(span_cds_tbl2, }\DataTypeTok{caption =} \StringTok{'Spanish language in child-directed speech }\CharTok{\textbackslash{}n}\StringTok{ estimates in U.S. corpus, by child and estimation method.'}\NormalTok{, }
             ...
             \DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
             \DataTypeTok{col.names =} \KeywordTok{c}\NormalTok{(}\StringTok{"Child ID"}\NormalTok{, }\StringTok{"Random"}\NormalTok{, }\StringTok{"All-day"}\NormalTok{, }\StringTok{"n=100 simulations of random sampling"}\NormalTok{, }\StringTok{"Parental Questionnaire"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{3}\NormalTok{, }\DataTypeTok{width =} \StringTok{"3cm"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{column_spec}\NormalTok{(}\DecValTok{4}\OperatorTok{:}\DecValTok{5}\NormalTok{, }\DataTypeTok{width =} \StringTok{"4cm"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable_styling}\NormalTok{() }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{add_header_above}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{" "}\NormalTok{ =}\StringTok{ }\DecValTok{1}\NormalTok{, }\StringTok{"From daylong recording"}\NormalTok{ =}\StringTok{ }\DecValTok{3}\NormalTok{, }\StringTok{" "}\NormalTok{ =}\StringTok{ }\DecValTok{1}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{kableExtra}\OperatorTok{::}\KeywordTok{kable_styling}\NormalTok{(}\DataTypeTok{latex_options =} \StringTok{"hold_position"}\NormalTok{)}
...
\centering
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{3cm}>{\raggedleft\arraybackslash}p{3cm}>{\raggedleft\arraybackslash}p{3cm}>{\raggedright\arraybackslash}p{4cm}>{\raggedright\arraybackslash}p{4cm}}
\toprule
\multicolumn{1}{c}{ } & \multicolumn{3}{c}{From daylong recording} & \multicolumn{1}{c}{ } \\
\cmidrule(l{3pt}r{3pt}){2-4}
Child ID & Random & All-day & n=100 simulations of random sampling & Parental Questionnaire\\
\midrule
179 & 0.53 & 0.52 & 0.52 ( 0.05 ) & .71\\
198-9mo & 0.78 & 0.64 & 0.65 ( 0.07 ) & .57\\
199 & 0.64 & 0.66 & 0.65 ( 0.07 ) & .94\\
261-8mo & 0.55 & 0.48 & 0.48 ( 0.05 ) & .69\\
267-12mo & 0.82 & 0.87 & 0.87 ( 0.04 ) & .87\\
\bottomrule
\end{tabular}
\end{table}
