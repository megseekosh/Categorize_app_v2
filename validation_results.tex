...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title=}\StringTok{"Proportion of language categories, by child and annotation method"}\NormalTok{,}
...
\midrule
Bolivia & 0.48 ( 0.14 ) & 0.42 ( 0.11 ) & r= 0.84 , p= 0.08 & 12.17 ( 12.56 )\\
US & 0.27 ( 0.17 ) & 0.27 ( 0.2 ) & r= 0.95 , p= 0.01 & 17.57 ( 12.74 )\\
\bottomrule
\end{tabular}
\end{table}
