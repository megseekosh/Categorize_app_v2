...
\NormalTok{us_lang_tbl2 <-}\StringTok{ }\KeywordTok{cbind}\NormalTok{(us_lang_tbl, us_cor) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{cbind}\NormalTok{(., us_rel_error) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{cbind}\NormalTok{(., span_sim_stats) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Corpus =} \StringTok{"Spanish-English (Spanish)"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{relocate}\NormalTok{(}\KeywordTok{c}\NormalTok{(Corpus, random, complete, rel_error_stats, sim_stat))}

\NormalTok{bo_lang_tbl2 <-}\StringTok{ }\KeywordTok{cbind}\NormalTok{(bo_lang_tbl, bo_cor) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{cbind}\NormalTok{(., bo_rel_error) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{cbind}\NormalTok{(., que_sim_stats) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(lang_tbl, }\DataTypeTok{caption =} \StringTok{'Average minority language estimates by corpus and annotation method.'}\NormalTok{, }
             \DataTypeTok{booktabs=}\NormalTok{T, }
             \DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
             \DataTypeTok{col.names =} \KeywordTok{c}\NormalTok{(}\StringTok{"Corpus (language)"}\NormalTok{, }\StringTok{"Random"}\NormalTok{, }\StringTok{"All-day"}\NormalTok{, }\StringTok{"Avg. relative error (SD)"}\NormalTok{, }\StringTok{"n=100 simulations of random sampling Avg. (SD) Range"}\NormalTok{, }\StringTok{"Correlation between estimates"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
...
\caption{(\#tab:generate lang tables)Average minority language estimates by corpus and annotation method.}
\centering
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{5.5cm}ll>{\raggedright\arraybackslash}p{3cm}>{\raggedright\arraybackslash}p{4cm}>{\raggedright\arraybackslash}p{4cm}}
\toprule
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Annotation Method} & \multicolumn{3}{c}{ } \\
\cmidrule(l{3pt}r{3pt}){2-3}
Corpus (language) & Random & All-day & Avg. relative error (SD) & n=100 simulations of random sampling Avg. (SD) Range & Correlation between estimates\\
\midrule
Spanish-English (Spanish) & 0.75 ( 0.13 ) & 0.69 ( 0.12 ) & 5.36 ( 4.82 ) & 0.73 ( 0.13 ) 0.46 - 0.98 & r= 0.96 , p= 0.01\\
Quechua-Spanish (Quechua) & 0.48 ( 0.11 ) & 0.5 ( 0.12 ) & 11.02 ( 4.28 ) & 0.48 ( 0.13 ) 0.22 - 0.75 & r= 0.9 , p= 0.04\\
\bottomrule
\end{tabular}
\end{table}
...
\NormalTok{final_reg_tbl <-}\StringTok{ }\NormalTok{cds_rel_error }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{relocate}\NormalTok{(corpus_id, random, complete, relative_error, sim_stat)}
...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(final_reg_tbl2, }\DataTypeTok{caption =} \StringTok{'Target child-directed speech estimates by child and annotation method.'}\NormalTok{, }
             \DataTypeTok{booktabs=}\NormalTok{T, }
             \DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
             \DataTypeTok{col.names =} \KeywordTok{c}\NormalTok{(}\StringTok{"Corpus (ID)"}\NormalTok{, }\StringTok{"Random"}\NormalTok{, }\StringTok{"All-day"}\NormalTok{, }\StringTok{"Relative error"}\NormalTok{, }\StringTok{"n=100 simulations of random sampling Avg. (SD) Range"}\NormalTok{, }\StringTok{"Within-corpus correlation between random and all-day estimates"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }\CommentTok{# "}
...
\StringTok{  }\KeywordTok{merge}\NormalTok{(., ads_rel_error, }\DataTypeTok{by=}\StringTok{'location'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{merge}\NormalTok{(., ads_sim_stats, }\DataTypeTok{by=}\StringTok{'location'}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{relocate}\NormalTok{(location, random, complete, rel_error_stats, sim_stat_ads)}
...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(final_reg_tbl, }\DataTypeTok{caption =} \StringTok{'Average adult-directed speech estimates by corpus and annotation method.'}\NormalTok{, }
             \DataTypeTok{booktabs=}\NormalTok{T, }
             \DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
             \DataTypeTok{col.names =} \KeywordTok{c}\NormalTok{(}\StringTok{"Corpus"}\NormalTok{, }\StringTok{"Random"}\NormalTok{, }\StringTok{"All-day"}\NormalTok{, }\StringTok{"Average relative error (SD)"}\NormalTok{, }\StringTok{"n=100 simulations of random sampling Avg. (SD) Range"}\NormalTok{,  }\StringTok{"Correlation between estimates"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
...
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{Annotation Method} & \multicolumn{3}{c}{ } \\
\cmidrule(l{3pt}r{3pt}){2-3}
Corpus & Random & All-day & Average relative error (SD) & n=100 simulations of random sampling Avg. (SD) Range & Correlation between estimates\\
\midrule
Quechua-Spanish & 0.42 ( 0.11 ) & 0.48 ( 0.14 ) & 12.17 ( 12.56 ) & 0.48 ( 0.13 ) 0.18 - 0.72 & r= 0.84 , p= 0.08\\
Spanish-English & 0.27 ( 0.2 ) & 0.27 ( 0.17 ) & 17.57 ( 12.74 ) & 0.27 ( 0.16 ) 0.01 - 0.65 & r= 0.95 , p= 0.01\\
\bottomrule
\end{tabular}
\end{table}
...
\NormalTok{random_cds_clips <-}\StringTok{ }\NormalTok{reg_annon }\OperatorTok{%>%}
...
\NormalTok{cdsspan_sim_data <-}\StringTok{ }\NormalTok{reg_annon }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"# of annotations"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
